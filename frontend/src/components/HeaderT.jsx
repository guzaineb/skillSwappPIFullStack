                              ...
                              <div className="media-body">
                                <h6>
                                  <a href="notifications.html">
                                    Lex Murphy requested <span>access to</span>{" "}
                          ...
                          <li className="notification-message">
                            <div className="media d-flex">
                              ...
                              <div className="media-body">
                                <h6>
                                  <a href="notifications.html">
                                    Ray Arnold left 6 <span>comments on</span>{" "}
                            ...
                            <div className="media d-flex">
                              ...
                              <div className="media-body">
                                ...
                                <p className="noti-details">
                                  ...
                                  twenty. So, some minor systems may go on and
                                  off for a while.”
                                </p>
                          ...
                          <li className="notification-message">
                            <div className="media d-flex">
                              ...
                              <div className="media-body">
                                <h6>
                                  <a href="notifications.html">
                                    John Hammond <span>created</span> Isla
                                    Nublar SOC2 compliance report{" "}
                                  </a>
                                </h6>
                  ...
                  <li className="nav-item user-nav">
                    ...
                    >
                      ...
                      <a
                        ...
                        href="setting-edit-profile.html"
                      >
