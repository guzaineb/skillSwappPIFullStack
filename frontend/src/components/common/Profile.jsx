...
function Profile() {
  ...
  const getSkills = async () => {
    ...
    const response = await axios.get(
      `http://localhost:5000/api/auth/profile/${user._id}/skills`
    );
                ...
                <ul className="nav header-navbar-rht">
                  ...
                  <li className="nav-item user-nav">
                    ...
                    >
                      ...
                      <a className="dropdown-item" href="student-settings.html">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-12">
                          <div className="contact-info">
                            <h6>Bio</h6>
                            <p>
                              Hello! I&apos;m Ronald Richard. I&apos;m
                              passionate about developing innovative software
                              solutions, analyzing classic literature. I aspire
                              to become a software developer, work as an editor.
                              In my free time, I enjoy coding, reading, hiking
                              etc.
                            </p>
                          </div>
                        </div>
