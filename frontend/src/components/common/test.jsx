...
import { Camera, UploadCloud, Trash2 } from 'lucide-react'; // Assuming you're using Lucide Icons
        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border">{user?.name || 'User'}</p>
            </div>
