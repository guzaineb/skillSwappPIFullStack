...
const INVITATION_EMAIL = `A friend invited you to join Skillswap!`;
/*const INVITATION_EMAIL = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
`*/
module.exports = {VERIFICATION_EMAIL_TEMPLATE,WELCOME_EMAIL, INVITATION_EMAIL}; // Exporter le modèle
