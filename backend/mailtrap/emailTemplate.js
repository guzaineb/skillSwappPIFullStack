...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color:rgb(215, 250, 222); padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    ...
    <p>Best regards,<br>SkillSwapp Team</p>
  </div>
...
module.exports = {VERIFICATION_EMAIL_TEMPLATE,WELCOME_EMAIL,PASSWORD_RESET_REQUEST_TEMPLATE}; // Exporter le modèle
